...
// Modify the 'Add device' button to 'Add Device Again'
createButtonForNavBar(
    'Add Device Again', // Change the button text here
...
// Add an event listener to the deviceDropdown for the 'change' event
